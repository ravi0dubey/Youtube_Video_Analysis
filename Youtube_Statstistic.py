...
# function to get videosid
    def get_videos_id(self,playlist_ID):
        ...
        while self.more_pages:
            ...
            self.next_page_token  = self.response2.get('nextPageToken')
        return video_ids


# Function to get each videos Statistics details
...
# Function to get each videos comments
#     def get_video_comments(self, video_ids):
    ...
    def get_video_comments(self):
        ...
        for item in response['items']:
            ...
            all_video_comments.append(video_stats)
